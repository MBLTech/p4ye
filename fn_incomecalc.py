...
def computepay():
    if hrs <= 40:
        ...
        otp = (hrs - 40) * 1.5 * rph + (40 * rph) # The net pay when being worked more than 40 hours calculating overtime with rate of 1.5 times of the orginal rate per hour, and the rest of 40 hours will be calculated as the normal rate per hour of the persion getting payment.
        return otp
